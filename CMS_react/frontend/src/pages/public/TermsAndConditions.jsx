    ...
    <div className="min-h-screen flex flex-col bg-white">
      ...
      <main className="flex-grow py-12 px-4 sm:px-6 lg:px-8 max-w-4xl mx-auto w-full">
        <div className="bg-white p-8 sm:p-12 rounded-2xl shadow-sm border border-slate-100 prose prose-slate max-w-none">
          <h1 className="text-3xl sm:text-4xl font-extrabold text-slate-900 mb-8 pb-4 border-b border-slate-200">
            AGREEMENT TO OUR LEGAL TERMS
          </h1>

          <p>
            We are TRUSTERLABS ("Company," "we," "us," "our"), a company registered in Rwanda at Kn7 st Kigali, Kigali, Kigali 00000.
          </p>
          <p>
            We operate the website <a href="https://trusterlabsacademy.com" target="_blank" rel="noopener noreferrer">https://trusterlabsacademy.com</a> (the "Site"), as well as any other related products and services that refer or link to these legal terms (the "Legal Terms") (collectively, the "Services").
          </p>
          <p>
          ...
          <p>
            These Legal Terms constitute a legally binding agreement made between you, whether personally or on behalf of an entity ("you"), and TRUSTERLABS, concerning your access to and use of the Services. You agree that by accessing the Services, you have read, understood, and agreed to be bound by all of these Legal Terms. <strong>IF YOU DO NOT AGREE WITH ALL OF THESE LEGAL TERMS, THEN YOU ARE EXPRESSLY PROHIBITED FROM USING THE SERVICES AND YOU MUST DISCONTINUE USE IMMEDIATELY.</strong>
          </p>
          ...
          <h2 className="text-2xl font-bold mt-12 mb-6">1. OUR SERVICES</h2>
          <p>
          ...
          <h3 className="text-xl font-bold mt-6 mb-4">Our intellectual property</h3>
          <p>
          ...
          <h3 className="text-xl font-bold mt-6 mb-4">Your use of our Services</h3>
          <p>
          ...
          <h3 className="text-xl font-bold mt-6 mb-4">Your submissions and contributions</h3>
          <p>
          ...
          <p>
            <strong>When you post Contributions, you grant us a license:</strong> By posting any Contributions, you grant us an unrestricted, unlimited, irrevocable, perpetual, non-exclusive, transferable, royalty-free, fully-paid, worldwide right, and license to: use, copy, reproduce, distribute, sell, resell, publish, broadcast, retitle, store, publicly perform, publicly display, reformat, translate, excerpt (in whole or in part), and exploit your Contributions (including, without limitation, your image, name, and voice) for any purpose, commercial, advertising, or otherwise, to prepare derivative works of, or incorporate into other works, your Contributions, and to sublicense the licenses granted in this section. Our use and distribution may occur in any media formats and through any media channels.
          </p>
          <p>
          ...
          <p><strong>Copyright infringement:</strong> We respect the intellectual property rights of others. If you believe that any material available on or through the Services infringes upon any copyright you own or control, please immediately refer to the "COPYRIGHT INFRINGEMENTS" section below.</p>

          <h2 className="text-2xl font-bold mt-12 mb-6">3. USER REPRESENTATIONS</h2>
          <p>
          ...
          <h2 className="text-2xl font-bold mt-12 mb-6">4. USER REGISTRATION</h2>
          <p>
            You may be required to register to use the Services. You agree to keep your password confidential and will be responsible for all use of your account and password. We reserve the right to remove, reclaim, or change a username you select if we determine, in our sole discretion, that such username is inappropriate, obscene, or otherwise objectionable.
          </p>

          <h2 className="text-2xl font-bold mt-12 mb-6">5. PURCHASES AND PAYMENT</h2>
          <p>We accept the following forms of payment:</p>
          <ul className="list-disc pl-6 space-y-2 mb-4">
            <li>PayPal</li>
            <li>5273640001936352</li>
          </ul>
          <p>
            You agree to provide current, complete, and accurate purchase and account information for all purchases made via the Services. You further agree to promptly update account and payment information, including email address, payment method, and payment card expiration date, so that we can complete your transactions and contact you as needed. Sales tax will be added to the price of purchases as deemed required by us. We may change prices at any time. All payments shall be in Rwf.
          </p>
          <p>
          ...
          <h2 className="text-2xl font-bold mt-12 mb-6">8. PROHIBITED ACTIVITIES</h2>
          ...
          <ul className="list-disc pl-6 space-y-2 mb-4">
            ...
            <li>Use the Services as part of any effort to compete with us or otherwise use the Services and/or the Content for any revenuegenerating endeavor or commercial enterprise.</li>
            <li>Use the Services to advertise or offer to sell goods and services.</li>
          </ul>

          <h2 className="text-2xl font-bold mt-12 mb-6">9. USER GENERATED CONTRIBUTIONS</h2>
          ...
          <h2 className="text-2xl font-bold mt-12 mb-6">10. CONTRIBUTION LICENSE</h2>
          ...
          <h2 className="text-2xl font-bold mt-12 mb-6">11. SOCIAL MEDIA</h2>
          ...
          <h2 className="text-2xl font-bold mt-12 mb-6">12. ADVERTISERS</h2>
          ...
          <h2 className="text-2xl font-bold mt-12 mb-6">13. SERVICES MANAGEMENT</h2>
          ...
          <h2 className="text-2xl font-bold mt-12 mb-6">14. PRIVACY POLICY</h2>
          <p>We care about data privacy and security. By using the Services, you agree to be bound by our Privacy Policy posted on the Services, which is incorporated into these Legal Terms. Please be advised the Services are hosted in Rwanda. If you access the Services from any other region of the world with laws or other requirements governing personal data collection, use, or disclosure that differ from applicable laws in Rwanda, then through your continued use of the Services, you are transferring your data to Rwanda, and you expressly consent to have your data transferred to and processed in Rwanda.</p>

          <h2 className="text-2xl font-bold mt-12 mb-6">15. COPYRIGHT INFRINGEMENTS</h2>
          ...
          <h2 className="text-2xl font-bold mt-12 mb-6">16. TERM AND TERMINATION</h2>
          ...
          <h2 className="text-2xl font-bold mt-12 mb-6">17. MODIFICATIONS AND INTERRUPTIONS</h2>
          ...
          <h2 className="text-2xl font-bold mt-12 mb-6">18. GOVERNING LAW</h2>
          <p>These Legal Terms shall be governed by and defined following the laws of Rwanda. TRUSTERLABS and yourself irrevocably consent that the courts of Rwanda shall have exclusive jurisdiction to resolve any dispute which may arise in connection with these Legal Terms.</p>

          <h2 className="text-2xl font-bold mt-12 mb-6">19. DISPUTE RESOLUTION</h2>
          ...
          <p><strong>Binding Arbitration:</strong> If the parties are unable to resolve the dispute through informal negotiation, the dispute shall be finally resolved by arbitration in accordance with the United Nations Commission on International Trade Law Arbitration Rules in force at the time of commencement of the arbitration. The number of arbitrators shall be two (2). The seat, or legal place, or arbitration shall be Kigali, Rwanda. The language of the proceedings shall be English. The governing law of these Legal Terms shall be substantive law of Rwanda.</p>
          ...
          <h2 className="text-2xl font-bold mt-12 mb-6">20. CORRECTIONS</h2>
          <p>There may be information on the Services that contains typographical errors, inaccuracies, or omissions, including descriptions, pricing, availability, and various other information. We reserve the right to correct any errors, inaccuracies, or omissions and to change or update the information on the Services at any time, without prior notice.</p>

          <h2 className="text-2xl font-bold mt-12 mb-6">21. DISCLAIMER</h2>
          ...
          <h2 className="text-2xl font-bold mt-12 mb-6">22. LIMITATIONS OF LIABILITY</h2>
          <p>IN NO EVENT WILL WE OR OUR DIRECTORS, EMPLOYEES, OR AGENTS BE LIABLE TO YOU OR ANY THIRD PARTY FOR ANY DIRECT, INDIRECT, CONSEQUENTIAL, EXEMPLARY, INCIDENTAL, SPECIAL, OR PUNITIVE DAMAGES, INCLUDING LOST PROFIT, LOST REVENUE, LOSS OF DATA, OR OTHER DAMAGES ARISING FROM YOUR USE OF THE SERVICES, EVEN IF WE HAVE BEEN ADVISED OF THE POSSIBILITY OF SUCH DAMAGES. NOTWITHSTANDING ANYTHING TO THE CONTRARY CONTAINED HEREIN, OUR LIABILITY TO YOU FOR ANY CAUSE WHATSOEVER AND REGARDLESS OF THE FORM OF THE ACTION, WILL AT ALL TIMES BE LIMITED TO THE LESSER OF THE AMOUNT PAID, IF ANY, BY YOU TO US DURING THE SIX (6) MONTH PERIOD PRIOR TO ANY CAUSE OF ACTION ARISING OR $10.00 USD. CERTAIN US STATE LAWS AND INTERNATIONAL LAWS DO NOT ALLOW LIMITATIONS ON IMPLIED WARRANTIES OR THE EXCLUSION OR LIMITATION OF CERTAIN DAMAGES. IF THESE LAWS APPLY TO YOU, SOME OR ALL OF THE ABOVE DISCLAIMERS OR LIMITATIONS MAY NOT APPLY TO YOU, AND YOU MAY HAVE ADDITIONAL RIGHTS.</p>

          <h2 className="text-2xl font-bold mt-12 mb-6">23. INDEMNIFICATION</h2>
          ...
          <h2 className="text-2xl font-bold mt-12 mb-6">24. USER DATA</h2>
          <p>We will maintain certain data that you transmit to the Services for the purpose of managing the performance of the Services, as well as data relating to your use of the Services. Although we perform regular routine backups of data, you are solely responsible for all data that you transmit or that relates to any activity you have undertaken using the Services. You agree that we shall have no liability to you for any loss or corruption of any such data, and you hereby waive any right of action against us arising from any such loss or corruption of such data.</p>

          <h2 className="text-2xl font-bold mt-12 mb-6">25. ELECTRONIC COMMUNICATIONS, TRANSACTIONS, AND SIGNATURES</h2>
          ...
          <h2 className="text-2xl font-bold mt-12 mb-6">26. CALIFORNIA USERS AND RESIDENTS</h2>
          <p>If any complaint with us is not satisfactorily resolved, you can contact the Complaint Assistance Unit of the Division of Consumer Services of the California Department of Consumer Affairs in writing at 1625 North Market Blvd., Suite N 112, Sacramento, California 95834 or by telephone at (800) 952-5210 or (916) 445-1254.</p>

          <h2 className="text-2xl font-bold mt-12 mb-6">27. MISCELLANEOUS</h2>
          ...
          <h2 className="text-2xl font-bold mt-12 mb-6">28. CONTACT US</h2>
          <p>In order to resolve a complaint regarding the Services or to receive further information regarding use of the Services, please contact us at:</p>
          <div className="bg-slate-50 p-6 rounded-lg mt-4 font-medium text-slate-800">
            <p>TRUSTERLABS</p>
            <p>Kn7 st Kigali</p>
